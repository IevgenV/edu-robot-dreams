...
class ProdServer(DailyDataSource):
    ...
    def __init__(self, cfg_filepath:pathlib.Path, server_name:str="prod_server"):
        assert isinstance(cfg_filepath, pathlib.Path), \
                "Configuration file must be specified with a pathlib.Path."
